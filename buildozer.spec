...
# comma separated e.g. requirements = python3,kivy==2.3.0,https://github.com/kivymd/KivyMD/archive/refs/heads/master.zip,androguard,openai,anthropic,requests,cryptography
requirements = python3,kivy==2.3.0,https://github.com/kivymd/KivyMD/archive/refs/heads/master.zip,androguard,openai,anthropic,requests,cryptography
